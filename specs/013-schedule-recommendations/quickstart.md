# Implementation Quickstart: Schedule Recommendations
...
2. Review requirements.md, confirm the approved demo travel-buffer-disabled
   rule, and identify any later Gate B-D or production decisions that still
   fail closed.
