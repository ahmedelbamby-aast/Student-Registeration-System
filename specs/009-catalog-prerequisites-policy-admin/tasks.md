...
- [ ] T001 Obtain human approval for SPEC-009.
...
- [ ] T004 [P] [US1] Add the future failing acceptance test for AC-1 (FR-2, FR-3) under tests/acceptance/009-catalog-prerequisites-policy-admin/.
- [ ] T005 [US1] Implement AC-1 only after approval, using the module paths declared in plan.md.
- [ ] T006 [P] [US2] Add the future failing acceptance test for AC-2 (FR-3) under tests/acceptance/009-catalog-prerequisites-policy-admin/.
- [ ] T007 [US2] Implement AC-2 only after approval, using the module paths declared in plan.md.
- [ ] T008 [P] [US3] Add the future failing acceptance test for AC-3 (FR-4, FR-5) under tests/acceptance/009-catalog-prerequisites-policy-admin/.
- [ ] T009 [US3] Implement AC-3 only after approval, using the module paths declared in plan.md.
- [ ] T010 [P] [US4] Add the future failing acceptance test for AC-4 (FR-1, FR-6, FR-7) under tests/acceptance/009-catalog-prerequisites-policy-admin/.
