...
- [x] T007 [GATE] Record Ahmed ELbamby's 2026-07-13 Gate A demo approval in specs/008-academic-term-student-profile/checklists/approval.md; do not start T008 or later before T001-T006 pass.
...
- [ ] T010 [P] [ENTITY-Student] [OWNER-SPEC-008] Create failing University-ID, provenance, active-state, rowversion, and versioned synthetic fixture-ordinal checks in tests/StudentRegistration.IntegrationTests/Specs/Spec008/StudentModelTests.cs.
...
- [ ] T040 [P] [AC-7] [NFR-1] [NFR-2] [NFR-3] [NFR-4] Create term/profile quality-gate coverage in tests/StudentRegistration.AcceptanceTests/Specs/Spec008/AC-7Tests.cs, including two migration-first rebuilds of one synthetic seed version with equal logical student/profile graphs, no production data, and no full-profile telemetry/evidence.
...
- [ ] T044 [P] [EC-2] Create missing imported GPA/provenance and incomplete synthetic seed-row fail-closed coverage in tests/StudentRegistration.IntegrationTests/Specs/Spec008/EdgeCases/EC-2Tests.cs.
...
- [ ] T063 [FR-5] [FR-7] [FR-8] [WORKSTREAM-STUDENT-ACADEMIC-PROFILE] Deliver academic profile and student-term guarding at src/StudentRegistration.Academics/Application/StudentAcademicProfileService.cs plus the synthetic complete-profile contribution at src/StudentRegistration.Academics/Application/DemoStudentProfileSeedContributor.cs after T053 fails; the contributor accepts the shared seed profile/ordinal and never imports production data.
