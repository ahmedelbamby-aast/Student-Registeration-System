...
- [x] T058 [FR-4] [WORKSTREAM-AUTHORIZATION-POLICIES] Create the failing role and resource-scope matrix in tests/StudentRegistration.AuthorizationTests/IdentityResourceScopeTests.cs.
...
- [x] T072 [FR-4] [WORKSTREAM-AUTHORIZATION-POLICIES] Deliver Identity-owned authorization policies at src/StudentRegistration.IdentityAccess/Application/Authorization/RolePolicies.cs after T058 fails.
