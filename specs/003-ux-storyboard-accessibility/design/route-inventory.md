...
**Contract version:** `route-inventory/1.0`  
**Source:** `.specify/route-manifest.json` version `2.0.0`  
...
with the single owner shown below.
...
| AUTH-02 | `/student/login` | `StudentLoginPage.razor` | SPEC-007 | SPEC-003, SPEC-007 | design-only |
| AUTH-03 | `/student/activate` | `StudentActivationPage.razor` | SPEC-007 | SPEC-003, SPEC-007 | design-only |
| AUTH-04 | `/staff/login` | `StaffLoginPage.razor` | SPEC-007 | SPEC-003, SPEC-007 | design-only |
| AUTH-05 | `/account/recovery` | `AccountRecoveryPage.razor` | SPEC-007 | SPEC-003, SPEC-007 | design-only |
| STU-01 | `/student` | `StudentDashboardPage.razor` | SPEC-008 | SPEC-003, SPEC-008 | design-only |
...
| ADM-01 | `/admin` | `AdminDashboardPage.razor` | SPEC-017 | SPEC-003, SPEC-017 | design-only |
...
| ADM-08 | `/admin/registrations` | `RegistrationAdministrationPage.razor` | SPEC-017 | SPEC-003, SPEC-014, SPEC-017 | design-only |
| ADM-09 | `/admin/audit` | `AuditAdministrationPage.razor` | SPEC-017 | SPEC-003, SPEC-017 | design-only |
| STF-01 | `/staff` | `StaffDashboardPage.razor` | SPEC-016 | SPEC-003, SPEC-016 | design-only |
...
| SYS-01 | `/status/{code}` | `SystemStatusPage.razor` | SPEC-003 | SPEC-003, SPEC-006, SPEC-007 | design-only |
