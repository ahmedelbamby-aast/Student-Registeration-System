...
| `STU-04-overload-approval-v2` (overload 19-21 eligible/ineligible/pending) | validation-error | authoritative 19-21 credit request state, CGPA-at-least-3.0 eligibility, Admin decision status, and absolute 21-credit ceiling | client-approved overload, more than 21 credits, hidden CGPA rule, or bypass action | Request approval, wait for an Admin decision, or revise to 18 credits | `STU-04-COMP-STATE-VALIDATION-ERROR` | `STU-04-E2E-FAILURE` |
