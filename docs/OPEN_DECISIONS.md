...
| DEC-06 | Is a travel-time buffer between different rooms/campuses required, and who approves its minutes/matrix? | Disable the hard travel-buffer rule until a typed, sourced, approved rule exists; never guess a duration. | SPEC-002, SPEC-013 |
