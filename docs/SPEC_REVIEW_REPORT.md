...
- 180 functional and 85 non-functional requirements;
- 140 Given/When/Then acceptance criteria, 92 edge cases, and 75 explicit
  out-of-scope guards;
- 1,470 exact-file tasks with test-before-delivery ordering;
- 27 canonical routes, 20 reusable frontend components, and 40 canonical API
  endpoints;
...
| SPEC-008 | Academic Term and Student Profile | Backend Lead | SPEC-002, SPEC-003, SPEC-005, SPEC-007, SPEC-018 |
...
| SPEC-011 | Eligibility and Subject Discovery | Product Owner | SPEC-002, SPEC-003, SPEC-008, SPEC-009, SPEC-010, SPEC-018 |
| SPEC-012 | Schedule Builder and Conflicts | Technical Lead | SPEC-003, SPEC-010, SPEC-011, SPEC-018 |
| SPEC-013 | Schedule Recommendations | Technical Lead | SPEC-003, SPEC-012, SPEC-018 |
...
| SPEC-017 | Admin Operations, Audit, and Reporting | Product Owner | SPEC-003, SPEC-007, SPEC-008, SPEC-009, SPEC-010, SPEC-014, SPEC-015, SPEC-016, SPEC-018 |
...
[endpoint-manifest.json](../.specify/endpoint-manifest.json) assigns each of 40
...
features consume them or, in SPEC-005, map them to SQL without redefining them.
The Staff and StaffTermAvailability ownership gaps were resolved explicitly.
