...
{
    [Fact]
    public void Adm_08_renders_authenticated_landmarks_and_operates_the_workspace_menu() =>
        AdminPageRenderHarness.AssertAuthenticatedShellAndMenuOperate("RegistrationAdministrationPage", "ADM-08");
