...
public sealed class AC_9Tests
{
    ...
    public void Authenticated_context_is_complete_authorized_and_fails_safe_when_a_contributor_is_missing()
    {
        ...
        // When GET /api/context composes both contributors for active, expiring, dual-role, no-applicable-term, and contributor-failure cases.
        ...
        // And activeRole is null only for role-selection-required, teaching/registration terms may be independently authoritative nulls, and a missing contributor returns a safe unavailable error with no partial context.
