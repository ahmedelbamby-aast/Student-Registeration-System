...
public static class Spec009Endpoints
{
    ...
    private static IResult GetPrograms(
        ...
        HttpContext context) =>
        ValidateList(query, page, pageSize, context)
        ?? CatalogueUnavailable(context);
    ...
    private static IResult GetDraft(
        ...
        HttpContext context) =>
        ValidateId(draftId, context) ?? CatalogueUnavailable(context);

    private static IResult UpdateDraft(
        [FromRoute] string draftId,
        CatalogueDraftMutationRequest request,
        HttpContext context) =>
        ValidateId(draftId, context)
    ...
    private static IResult CreateImport(
